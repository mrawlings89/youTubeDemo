...
class VideoCell: BaseCell  {
    ...
    let thumbnailImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "Salad_Days_Preview")
    ...
    let titleLabel: UILabel = {
        ...
        label.text = "Mac Demarco - Salad Days"
        return label
    }()
    ...
    let subtitleTextView: UITextView = {
        ...
        textView.text = "Gaston Bordet • 9.3M views • 3 years ago"
